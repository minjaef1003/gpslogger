...
public class Gpx10FileLoggerStatistics implements Statistics {

	public Gpx10FileLoggerStatistics(File setGpxFile, boolean setAddNewTrackSegment) {
        super();
    }
...
class Gpx10AnnotateHandler implements Runnable {
    ...
    public void run() {
        ...
        synchronized (Gpx10FileLoggerStatistics.lock) {
            ...
            try {
                ...
                LOG.error("Gpx10FileLoggerStatistics.annotate", e);
            }
    ...
    public void run() {
        synchronized (Gpx10FileLoggerStatistics.lock) {
            ...
            try {
                ...
                LOG.error("Gpx10FileLoggerStatistics.write", e);
            }
